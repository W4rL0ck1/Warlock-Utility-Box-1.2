...
namespace treino
{
    public partial class Form2 : Form
    {
        ...
        {
            comboBoxNomeDns.Items.Clear();
            comboBoxNomeDns.Items.AddRange(new object[] { ini1.IniReadString("Ping1"), ini1.IniReadString("Ping2"), ini1.IniReadString("Ping3"), ini1.IniReadString("Ping4"), ini1.IniReadString("Ping5"), ini1.IniReadString("Ping6"), ini1.IniReadString("Ping7"), ini1.IniReadString("Ping8"), ini1.IniReadString("Ping9"), ini1.IniReadString("Ping10") });
